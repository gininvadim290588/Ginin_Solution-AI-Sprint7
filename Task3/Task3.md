...
В рамках пилота AI-сервис не принимает решение о признании операции подозрительной. Его задача — рассчитывать приоритет операции для ручной проверки сотрудником финансового мониторинга. Обязательные AML-правила, внешние сигналы и ответственность сотрудников банка сохраняются.
...
## 4. C4 Component для Review Ranking Service
Диаграмма представлена в папке Diagrams
